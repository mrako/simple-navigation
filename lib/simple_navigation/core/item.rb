module SimpleNavigation
  ...
  class Item
    attr_reader :key, :url, :sub_navigation, :method, :highlights_on, :not_selected_with_submenu
    ...
    def initialize(container, key, name, url, options, items=nil, &sub_nav_block)
      ...
      @not_selected_with_submenu = options[:not_selected_with_submenu].present? ? options.delete(:not_selected_with_submenu) : false
    ...
    def selected_by_subnav?
      sub_navigation && sub_navigation.selected? && !@not_selected_with_submenu
    end
